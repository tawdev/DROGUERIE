-- Script complet pour insérer les catégories et produits
-- Exécuter ce script EN UNE SEULE FOIS dans phpMyAdmin ou MySQL
...
-- Insertion des catégories (OBLIGATOIRE avant les produits)
...
-- Insertion des produits (APRÈS les catégories)
