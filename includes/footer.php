        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section footer-about">
                    ...
                    <p>Votre droguerie de confiance au Maroc. Matériaux de construction, quincaillerie et outillage de qualité pour tous vos projets.</p>
                    <div class="footer-social">
                        ...
                        <a href="#" class="social-icon" aria-label="WhatsApp" title="WhatsApp" target="_blank" rel="noopener noreferrer">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="footer-section footer-contact">
                    ...
                    <div class="contact-item-footer">
                        <div class="contact-icon-wrapper-footer">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="contact-info-footer">
                            ...
                            <a href="tel:+212524308038">+212 524 308 038</a>
                        </div>
                    </div>
                    <div class="contact-item-footer">
                        <div class="contact-icon-wrapper-footer">
                        ...
                        <div class="contact-info-footer">
                            <strong>Email</strong>
                            <a href="mailto:contact@droguerie.com">contact@droguerie.com</a>
                        </div>
                    </div>
                    <div class="contact-item-footer">
                        <div class="contact-icon-wrapper-footer">
                        ...
                        <div class="contact-info-footer">
                            ...
                            <span>48 AV Alla El Fassi<br>Marrakech 40000, Morocco</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-content" style="text-align: center; justify-content: center; align-items: center; display: flex; flex-direction: column; gap: 1rem; width: 100%;" >
                    <p>&copy; <?php echo date('Y'); ?> <strong>C-Digital</strong>. Tous droits réservés.</p>
